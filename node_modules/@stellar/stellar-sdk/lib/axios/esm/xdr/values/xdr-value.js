import { areUint8ArraysEqual, uint8ArrayToHex, hexToUint8Array } from 'uint8array-extras';
import { uint8ArrayToBase64, base64ToUint8Array } from '../../base/util/base64.js';
import { XdrError, array, UNBOUNDED_MAX_LENGTH, Reader } from '@stellar/js-xdr';
...
class XdrValue {
  ...
  static fromJson(json) {
    ...
    return this.fromXdrObject(walkFromJson(json, this.schema));
  }
}
...
function decodeBytes(input, format) {
  ...
  if (format === "hex" || format === "base64") {
    try {
      return format === "hex" ? hexToUint8Array(input) : base64ToUint8Array(input);
    } catch {
...
export { XdrValue, decodeArray, decodeBytes, decodeStream, encodeArray, encodeBytes };
