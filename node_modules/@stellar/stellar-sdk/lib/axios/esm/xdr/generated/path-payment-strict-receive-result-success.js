...
class PathPaymentStrictReceiveResultSuccess extends XdrValue {
  offers;
  last;
  static schema = struct("PathPaymentStrictReceiveResultSuccess", {
...
export { PathPaymentStrictReceiveResultSuccess };
