...
class BumpSequenceResultBase extends XdrValue {
  constructor() {
    super();
  ...
  static schema = union(
    "BumpSequenceResult",
    {
      ...
      cases: [
        _case("bumpSequenceSuccess", 0, _void()),
        _case("bumpSequenceBadSeq", -1, _void())
      ],
      switchKey: "code"
    }
  );
...
export { BumpSequenceResult, BumpSequenceResultBadSeq, BumpSequenceResultSuccess };
