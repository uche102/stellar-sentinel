 ...
 * ```
 */
export declare class SorobanTransactionMetaExtV1 extends XdrValue {
    ...
    static readonly schema: XdrType<SorobanTransactionMetaExtV1Wire>;
    constructor(input: {
        ext: ExtensionPoint;
        totalNonRefundableResourceFeeCharged: bigint;
        totalRefundableResourceFeeCharged: bigint;
    ...
    static fromXdrObject(wire: SorobanTransactionMetaExtV1Wire): SorobanTransactionMetaExtV1;
}
