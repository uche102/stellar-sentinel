...
class TimeSlicedSurveyStopCollectingMessage extends XdrValue {
  surveyorId;
  nonce;
  ledgerNum;
  static schema = struct("TimeSlicedSurveyStopCollectingMessage", {
...
export { TimeSlicedSurveyStopCollectingMessage };
