import { ScMapEntry, ScVal } from "../xdr/index.js";
 ...
 * ```
 */
export declare function nativeToScVal(val: unknown, opts?: NativeToScValOpts): ScVal;
/**
 ...
 * @see nativeToScVal
 */
export declare function scValToNative(scv: ScVal): any;
/**
 * Build a sorted ScVal map from unsorted entries, sorted by key.
 *
 * @param items - the unsorted map entries
 */
export declare function scvSortedMap(items: ScMapEntry[]): ScVal;
export {};
