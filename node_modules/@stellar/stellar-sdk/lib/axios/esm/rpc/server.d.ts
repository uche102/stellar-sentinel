import { Account, Address, Asset, Contract, FeeBumpTransaction, Transaction } from "../base/index.js";
import { Api } from "./api.js";
import type { HttpClient } from "../http-client/index.js";
import { AccountEntry, ClaimableBalanceEntry, ContractExecutableExternalRef, LedgerKey, ScContractInstance, ScVal, TrustLineEntry } from "../xdr/index.js";
/**
...
export declare class RpcServer {
     ...
     * ```
     */
    getContractData(contract: string | Address | Contract, key: ScVal, durability?: Durability): Promise<Api.LedgerEntryResult>;
    /**
     ...
     * ```
     */
    getExternalRefWasmHash(ref: ContractExecutableExternalRef): Promise<Uint8Array>;
    /**
     ...
     * ```
     */
    getContractWasmByHash(wasmHash: Uint8Array | string, format?: undefined | "hex" | "base64"): Promise<Uint8Array>;
    /**
     ...
     * ```
     */
    getLedgerEntries(...keys: LedgerKey[]): Promise<Api.GetLedgerEntriesResponse>;
    _getLedgerEntries(...keys: LedgerKey[]): Promise<Api.RawGetLedgerEntriesResponse>;
    getLedgerEntry(key: LedgerKey): Promise<Api.LedgerEntryResult>;
    /**
     ...
     * ```
     */
    prepareTransaction(tx: Transaction | FeeBumpTransaction, useUpgradedAuth?: boolean): Promise<Transaction>;
    /**
