import { union, case as _case, void as _void, field, array, lazy, option, int64, XdrError } from '@stellar/js-xdr';
import { XdrValue } from '../values/xdr-value.js';
import { ClaimPredicateType } from './claim-predicate-type.js';

class ClaimPredicateBase extends XdrValue {
  constructor() {
    super();
  ...
  static schema = union(
    "ClaimPredicate",
    {
      ...
      cases: [
        _case("claimPredicateUnconditional", 0, _void()),
        _case(
          "claimPredicateAnd",
          1,
          field(
...
export { ClaimPredicate, ClaimPredicateAnd, ClaimPredicateBeforeAbsoluteTime, ClaimPredicateBeforeRelativeTime, ClaimPredicateNot, ClaimPredicateOr, ClaimPredicateUnconditional };
