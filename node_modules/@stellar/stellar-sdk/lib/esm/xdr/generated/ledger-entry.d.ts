...
import { LedgerEntryData, type LedgerEntryDataWire } from "./ledger-entry-data.js";
 ...
 * ```
 */
export declare class LedgerEntry extends XdrValue {
    readonly lastModifiedLedgerSeq: number;
    readonly data: LedgerEntryData;
    readonly ext: LedgerEntryExt;
    static readonly schema: XdrType<LedgerEntryWire>;
    constructor(input: {
        lastModifiedLedgerSeq: number;
