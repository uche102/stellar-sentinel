...
import { type AssembledTransactionOptions } from "./types.js";
...
export declare function parseWasmCustomSections(buffer: Uint8Array): Map<string, Uint8Array[]>;
/**
 * Reads a binary stream of ScSpecEntries into an array for processing by ContractSpec
 * @hidden
 */
export declare function processSpecEntryStream(buffer: Uint8Array): ScSpecEntry[];
