...
import { SendFailedError, SendResultOnlyError, TransactionStillPendingError } from "./errors.js";
/**
...
export declare class SentTransaction<T> {
    ...
    static Errors: {
        SendFailed: typeof SendFailedError;
        SendResultOnly: typeof SendResultOnlyError;
        TransactionStillPending: typeof TransactionStillPendingError;
    };
