import { Account, SorobanDataBuilder, TransactionBuilder, authorizeEntry as stellarBaseAuthorizeEntry } from "../base/index.js";
...
import { Operation as XdrOperation, SorobanTransactionData } from "../xdr/index.js";
/**
...
export declare class AssembledTransaction<T> {
     ...
     */
    static fromJSON<T>(...args: Parameters<typeof AssembledTransaction.fromJson<T>>): AssembledTransaction<T>;
    /**
     ...
     * Deprecated in version v17.0.0
     */
    static fromXDR<T>(...args: Parameters<typeof AssembledTransaction.fromXdr<T>>): AssembledTransaction<T>;
     ...
     * ```
     */
    static buildWithOp<T>(operation: XdrOperation, options: AssembledTransactionOptions<T>): Promise<AssembledTransaction<T>>;
