 ...
 */
export declare function decodeCheck(versionByteName: string, encoded: string): Uint8Array;
/**
 ...
 */
export declare function encodeCheck(versionByteName: string, data: Uint8Array): string;
export {};
