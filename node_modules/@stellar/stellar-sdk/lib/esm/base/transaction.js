...
import { TransactionSignaturePayloadTaggedTransaction } from '../xdr/generated/transaction-signature-payload-tagged-transaction.js';
import { TransactionSignaturePayload } from '../xdr/generated/transaction-signature-payload.js';
import { TransactionV1Envelope } from '../xdr/generated/transaction-v1-envelope.js';
import { TransactionV0Envelope } from '../xdr/generated/transaction-v0-envelope.js';
import { HashIdPreimageOperationId } from '../xdr/generated/hash-id-preimage-operation-id.js';
import { Transaction as Transaction$1 } from '../xdr/generated/transaction.js';
import { Hash } from '../xdr/generated/hash.js';
import { TransactionV0 } from '../xdr/generated/transaction-v0.js';
...
class Transaction extends TransactionBase {
  ...
  signatureBase() {
    ...
    const taggedTransaction = TransactionSignaturePayloadTaggedTransaction.envelopeTypeTx(
      tx
    );
      ...
      case "envelopeTypeTxV0":
        envelope = TransactionEnvelope.envelopeTypeTxV0(
          new TransactionV0Envelope({
            tx: TransactionV0.fromXdr(rawTx),
            // make a copy of tx
            signatures
          })
        );
      ...
      case "envelopeTypeTx":
        envelope = TransactionEnvelope.envelopeTypeTx(
          new TransactionV1Envelope({
            tx: Transaction$1.fromXdr(rawTx),
            // make a copy of tx
            signatures
          })
        );
