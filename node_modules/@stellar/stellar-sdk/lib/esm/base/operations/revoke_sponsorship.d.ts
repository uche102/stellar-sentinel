...
import { RevokeAccountSponsorshipOpts, RevokeTrustlineSponsorshipOpts, RevokeOfferSponsorshipOpts, RevokeDataSponsorshipOpts, RevokeClaimableBalanceSponsorshipOpts, RevokeLiquidityPoolSponsorshipOpts, RevokeSignerSponsorshipOpts } from "./types.js";
/**
 ...
 * ```
 */
export declare function revokeAccountSponsorship(opts?: RevokeAccountSponsorshipOpts): Operation;
/**
 ...
 * ```
 */
export declare function revokeTrustlineSponsorship(opts?: RevokeTrustlineSponsorshipOpts): Operation;
/**
 ...
 * ```
 */
export declare function revokeOfferSponsorship(opts?: RevokeOfferSponsorshipOpts): Operation;
/**
 ...
 * ```
 */
export declare function revokeDataSponsorship(opts?: RevokeDataSponsorshipOpts): Operation;
/**
 ...
 * ```
 */
export declare function revokeClaimableBalanceSponsorship(opts?: RevokeClaimableBalanceSponsorshipOpts): Operation;
/**
 ...
 * ```
 */
export declare function revokeLiquidityPoolSponsorship(opts?: RevokeLiquidityPoolSponsorshipOpts): Operation;
/**
 ...
 * ```
 */
export declare function revokeSignerSponsorship(opts?: RevokeSignerSponsorshipOpts): Operation;
