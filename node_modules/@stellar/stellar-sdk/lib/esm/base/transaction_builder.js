...
import { Int64, Uint64 } from '../xdr/index.js';
...
import { SorobanAuthorizedInvocation } from '../xdr/generated/soroban-authorized-invocation.js';
import { SorobanAuthorizedFunction } from '../xdr/generated/soroban-authorized-function.js';
import { SorobanCredentials } from '../xdr/generated/soroban-credentials.js';
import { TimeBounds } from '../xdr/generated/time-bounds.js';
import { LedgerBounds } from '../xdr/generated/ledger-bounds.js';
import { Preconditions } from '../xdr/generated/preconditions.js';
import { PreconditionsV2 } from '../xdr/generated/preconditions-v2.js';
import { TransactionExt } from '../xdr/generated/transaction-ext.js';
import { FeeBumpTransactionExt } from '../xdr/generated/fee-bump-transaction-ext.js';
import { FeeBumpTransactionInnerTx } from '../xdr/generated/fee-bump-transaction-inner-tx.js';
import { InvokeContractArgs } from '../xdr/generated/invoke-contract-args.js';
import { LedgerFootprint } from '../xdr/generated/ledger-footprint.js';
...
import { SorobanResources } from '../xdr/generated/soroban-resources.js';
import { SorobanTransactionDataExt } from '../xdr/generated/soroban-transaction-data-ext.js';
import { Transaction as Transaction$1 } from '../xdr/generated/transaction.js';
import { TransactionEnvelope } from '../xdr/generated/transaction-envelope.js';
import { TransactionV1Envelope } from '../xdr/generated/transaction-v1-envelope.js';
import { MuxedAccount as MuxedAccount$1 } from '../xdr/generated/muxed-account.js';
import { FeeBumpTransaction as FeeBumpTransaction$1 } from '../xdr/generated/fee-bump-transaction.js';
import { FeeBumpTransactionEnvelope } from '../xdr/generated/fee-bump-transaction-envelope.js';
...
class TransactionBuilder {
  ...
  build() {
    ...
    if (this.hasV2Preconditions()) {
      ...
      const minSeqNum = this.minAccountSequence ? Int64.fromString(this.minAccountSequence) : null;
  ...
  static buildFeeBumpTransaction(feeSource, baseFee, innerTx, networkPassphrase) {
    ...
    if (innerTxEnvelope.type === "envelopeTypeTxV0") {
      ...
      const v1Tx = new Transaction$1({
        sourceAccount: MuxedAccount$1.keyTypeEd25519(
    ...
    const tx = new FeeBumpTransaction$1({
    ...
    const envelope = TransactionEnvelope.envelopeTypeTxFeeBump(feeBumpTxEnvelope);
